...
/* R1 */
#define MMC_WRITE_BLOCK_SINGLE		24
...
/* memory power-up status bit */
#define MMC_OCR_MEM_READY		(1 << 31)
...
/* MMC 1.0 - 1.2 */
#define MMC_CSD_MMCVER_1_0		0

/* MMC 1.4 */
#define MMC_CSD_MMCVER_1_4		1

/* MMC 2.0 - 2.2 */
#define MMC_CSD_MMCVER_2_0		2

/* MMC 3.1 - 3.3 */
#define MMC_CSD_MMCVER_3_1		3

/* MMC 4 */
#define MMC_CSD_MMCVER_4_0		4
