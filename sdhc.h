...
/* excluding vendor signals */
#define SDHC_EINTR_STATUS_MASK		0x03ff
...
/* excluding vendor signals */
#define SDHC_EINTR_SIGNAL_MASK		0x03ff
...
/* 0=KHz, 1=MHz */
#define SDHC_TIMEOUT_FREQ_UNIT		(1 << 7)
...
#define SDHC_TIMEOUT_FREQ_KHZ(cap)	(((cap) & SDHC_TIMEOUT_FREQ_UNIT) ? \
						SDHC_TIMEOUT_FREQ(cap) * 1000 : SDHC_TIMEOUT_FREQ(cap))
...
struct sdhc_host
{
	...
	u_int16_t intr_status;

	/* soft error status */
	u_int16_t intr_error_status;
